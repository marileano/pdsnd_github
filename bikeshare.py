...
def get_filters():
    ...
    """
    print('Hello! Let\'s explore some Bikeshare US Data!')
    ...
    day = get_user_input('One more thing! What day of the week do you want to analyze?'\
...
def station_stats(df):
    ...
    most_common_start_end_station = df['Start End'] = df['Start Station'].map(str) + '&' + df['End Station']
